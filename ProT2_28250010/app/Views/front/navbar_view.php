...
<!-- Muestra los mensajes de flashdata -->
<div class="container mt-3">
    <?php if (!empty(session()->getFlashdata('success'))): ?>
        <div class="alert alert-success" style="background-color: #00FF00; color: #000000; text-align: center; padding: 10px;">
            <?= session()->getFlashdata('success'); ?>
        </div>
    <?php endif ?>

    <?php if (!empty(session()->getFlashdata('fail'))): ?>
        <div class="alert alert-danger" style="background-color: #FF0000; color: #FFFFFF; text-align: center; padding: 10px;">
